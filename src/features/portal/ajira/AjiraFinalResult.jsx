...
export default function AjiraFinalResult({ registrationScore, profileScore }) {
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <h2 className="text-xl sm:text-2xl font-extrabold text-slate-900">
          Tathmini ya Mwisho — Ajira Portal
        </h2>
        <p className="text-slate-500 mt-1 text-sm">
          Hapa chini ni muhtasari wa utayari wako wa kusajili Ajira Portal.
        </p>
      </div>
      ...
      {isReady ? (
        <div className="bg-blue-50 border border-blue-100 rounded-2xl p-5 space-y-3">
          <p className="font-bold text-blue-800">🎉 Hongera! Uko tayari kusajili Ajira Portal.</p>
          <p className="text-blue-700 text-sm leading-relaxed">
            Nenda kwenye portal ya Ajira na uanze mchakato wa usajili sasa hivi.
          </p>
          <a
